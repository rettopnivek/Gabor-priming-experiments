...
% in general luminance values are defined between 0 and 1 with 255 steps 
% in between. All values in Psychtoolbox are defined between 0 and 1
white = WhiteIndex(0);
black = BlackIndex(0);
...
% we have two screens attached to our monitor we will draw to the initial
% screen.
