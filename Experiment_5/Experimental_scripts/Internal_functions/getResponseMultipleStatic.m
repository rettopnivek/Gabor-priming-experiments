...
primeMask = nuisanceInputs{12};
NeitherPrime = nuisanceInputs{13};
maskString = nuisanceInputs{14};
optionalString = nuisanceInputs{15};
lnSpace = nuisanceInputs{16};
...
while ~resp
    ...
    if ( GetSecs > trackFrame )
        ...
        if size( optionalString, 2 ) ~= 1
            [nx,ny,bbox] = DrawFormattedText( window, optionalString, ...
