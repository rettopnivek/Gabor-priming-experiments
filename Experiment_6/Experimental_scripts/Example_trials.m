...
prompt = {...
    % Line 1
    sprintf( ...
    [ 'Experiment type, debug status, prime types, and trial number' ...
    '\n(2 or 3, 0 - 2, 1 - 3, 1 onwards)' ] ) ...
    % Line 2
...
% Extract experiment version, where...
% 2 = 2AFC with no mask, between left versus right
% 3 = S/D with mask, same versus different
experiment_ver = tmp(1);
